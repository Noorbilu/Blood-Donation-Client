      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-10">
        {steps.map((item, i) => (
          <motion.div
            ...
            className="rounded-3xl overflow-hidden shadow-md bg-base-100 border border-base-300 hover:border-primary/40 transition-all duration-300 cursor-pointer backdrop-blur-sm"
          >
            <div className="relative h-56 overflow-hidden">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-black/20 to-transparent flex items-center justify-center">
                <div className="bg-base-100/90 p-3 rounded-full shadow-md">
                  {item.icon}
                </div>
              </div>
            </div>
